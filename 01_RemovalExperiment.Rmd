...
eri_glmmTMB <- glmmTMB(glmmTMB_formula,      data = eri_removal, family = beta_family())
sol_glmmTMB <- glmmTMB(glmmTMB_formula,      data = sol_removal, family = beta_family())
lup_glmmTMB <- glmmTMB(glmmTMB_formula_poly, data = lup_removal, family = beta_family())
...
# Plots
(eri_plot <- ggplot(eri_df, aes(x = elevation, y = pred_pct, color = treatment)) +
  geom_point(data = eri_removal,
             aes(x = elevation, y = cover_focal_sp_percentage, color = treatment),
             alpha = 0.5) +
...
(sol_plot <- ggplot(sol_df, aes(x = elevation, y = pred_pct, color = treatment)) +
...
(lup_plot <- ggplot(lup_df, aes(x = elevation, y = pred_pct, color = treatment)) +
