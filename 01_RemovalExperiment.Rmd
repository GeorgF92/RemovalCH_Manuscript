...
colnames(env_df) <- c("Elevation [m]", "Precipitation", "Temperature", "Pop. Density")

# Compute Pearson correlation
cor_mat <- cor(env_df, method = "pearson")

# Plot and export correlation heatmap
png("Figures/Fig_Sx_CorrelationMatrix.png", width = 10, height = 11, units = "cm", res = 600)
corrplot(cor_mat,
         method = "color",                          
         type = "upper",                            
         addCoef.col = "black",                     
